...
namespace NewPSL.Controllers
{
    public class EmployeeRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeRoleId,RoleName")] EmployeeRole employeeRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeRoleId,RoleName")] EmployeeRole employeeRole)
        {
            if (ModelState.IsValid)
            {
